                ...
                <Row>
                  <Col md={12}>
                    <div className="flex flex-column gap-2 div_input">
                      <label htmlFor="username">اضافة قسم جديد </label>
                         <input placeholder="اضافة قسم جديد" type="text" className="input" id="username" required />
                         </div>
                  </Col>
                  ...
                  <Col md={12}>
                    <div className="flex flex-column gap-2 div_input">
                      <label htmlFor="username"> اسم المنتج </label>
                      <input placeholder="اضافة اسم المنتج" type="text" className="input" id="username" required />
                      </div>
                  </Col>
                  <Col md={12}>
                  <div className="flex flex-column gap-2 div_input">
                      <label htmlFor="username"> العبوه  </label>
                      <input placeholder="اضافة العبوه  " type="text" className="input" id="username" required />
                      </div>
                  </Col>
                  ...
                  <Col md={12}>
                    <div className="flex flex-column gap-2 div_input">
                      <label htmlFor="username">القسم  </label>
                      <Dropdown
